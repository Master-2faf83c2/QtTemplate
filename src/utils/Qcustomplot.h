...
# endif
  ...
  // static methods:
  QDateTime keyToDateTime(double key);
  double dateTimeToKey(const QDateTime &dateTime);
  double dateTimeToKey(const QDate &date, Qt::TimeSpec timeSpec=Qt::LocalTime);
